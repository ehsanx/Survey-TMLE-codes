...
# Writes: results/R02_largem_sweep_summary.csv   (per m x rung x method)
#         results/R02_largem_sweep_diag.csv      (targeting/positivity per cell)
...
RUN_DIR <- file.path(REPO_ROOT, "simulation", "enhancements", RUN_ID)
