...
#
# WHY THIS RUN EXISTS
#   The headline run (simulation/run_sim.R) builds the population with
...
#
# NON-DESTRUCTIVE: this driver SOURCES R/*.R unchanged. The only new logic
...
CODE <- Sys.getenv("SIM_CODE", "R")          # set SIM_CODE to the code dir on ARC
