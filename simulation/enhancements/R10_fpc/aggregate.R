...
# Run AFTER the array job finishes:  Rscript simulation/enhancements/R10_fpc/aggregate.R
# Reads sim_output/arc_runs/R10_fpc/*.rds, writes results/R10_fpc_*.csv.
...
RUN_DIR <- file.path(REPO_ROOT, "simulation", "enhancements", "R10_fpc")
