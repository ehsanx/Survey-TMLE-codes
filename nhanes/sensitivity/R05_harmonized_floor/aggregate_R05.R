...
#   Combine R05 per-cell nh_*.rds -> results/R05_summary.csv (+ diagnostics).
# Mirrors nhanes/aggregate_nhanes.R but for the 6-arm R05 output and writes to
# the NON-DESTRUCTIVE results/ location (never the locked nhanes_output/results).
