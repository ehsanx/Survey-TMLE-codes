# =====================================================================
# nhanes/01_build_analytic.R  —  per-example analytic datasets from cached raw
#
# For each example E1..E4 (nhanes/examples.R) this:
...
source(file.path(REPO_ROOT, "nhanes", "examples.R"))
...
derive_E4 <- function(df) {                       # GDM -> hypertension (ever-pregnant non-diabetic women 20+)
  ...
  df$agefirst <- na_if_in(df$RHD180, c(777, 999))   # RHD180 is 3-digit: refused/dont-know are 777/999
