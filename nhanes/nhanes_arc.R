# =====================================================================
# nhanes/nhanes_arc.R  —  NHANES application as a SLURM ARRAY job on UBC ARC
#
# Mirrors simulation/run_sim.R, but on the FOUR fixed real analytic datasets instead of
