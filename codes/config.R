...
DATA_ROOT <- Sys.getenv("DATA_ROOT", "sim_output")

# ---- small/organized outputs (in repo, safe to commit) ---------------
RESULTS_DIR <- file.path(REPO_ROOT, "results")   # summary tables (CSV)
IMAGES_DIR  <- file.path(REPO_ROOT, "images")    # figures

# ---- full simulation outputs (organized under DATA_ROOT) -------------
