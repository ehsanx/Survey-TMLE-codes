...
#
#   Outputs (Step 1 of plan-phase3.md):
#     Writing/manuscript/images/fig1_ladder_coverage.png   (300 dpi, B&W)
#     Writing/manuscript/images/fig1_ladder_coverage.pdf   (vector, for LaTeX)
#     results/table1_main.csv                               (the table data)
#     Writing/manuscript/table1_main.tex                    (booktabs fragment)
#
#   Usage:  Rscript codes/make_figures.R   (run from repo root or anywhere;
#           config.R is located robustly, as in aggregate_sim.R)
# =====================================================================

# ---- locate config.R robustly (mirrors aggregate_sim.R) --------------
...
draw_fig1 <- function() {
  ...
  par(mfrow = c(1, 2), mar = c(4.4, 4.2, 2.4, 0.8), mgp = c(2.5, 0.8, 0),
...
lines <- c(
  "% Auto-generated by codes/make_figures.R -- do not edit by hand.",
...
tex_path <- file.path(REPO_ROOT, "Writing", "manuscript", "table1_main.tex")
