...
# building blocks via nuisance_rate_helpers.R. It NEVER edits codes/*.R and writes
# only into sim_output/arc_runs/R04_nuisance_rate/ + results/arc/.
#
...
.this_dir <- Sys.getenv("R04_DIR",
  file.path(REPO_ROOT, "codes", "arc_runs", "R04_nuisance_rate"))
