...
# learners) and a run-local helpers.R. It NEVER edits codes/*.R. The m knob is
...
#   summary CSV   -> results/arc/R02_largem_sweep_summary.csv (written by
...
RUN_DIR <- file.path(REPO_ROOT, "codes", "arc_runs", "R02_largem_sweep")
