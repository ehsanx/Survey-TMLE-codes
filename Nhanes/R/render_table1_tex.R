...
# Output: Writing/Appendix/webE_table1s.tex  (four \begin{table} blocks).
# =====================================================================
...
tex <- paste(c("% Auto-generated by Nhanes/R/render_table1_tex.R -- do not edit by hand.",
               ...
               blocks), collapse = "\n\n")
writeLines(tex, "Writing/Appendix/webE_table1s.tex")
cat(tex)
cat("\n\n--- wrote Writing/Appendix/webE_table1s.tex ---\n")
