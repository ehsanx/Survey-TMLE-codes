# =====================================================================
# Nhanes/R/00_download_cache.R  —  reproducible raw NHANES download + cache
#
# Downloads (via nhanesA) every component table needed across the four examples
# (Nhanes/R/examples.R) for cycles 2007-2008 .. 2017-2018, caches each raw table
...
#
# Usage:  Rscript Nhanes/R/00_download_cache.R        (full union; idempotent)
#         SIM_NH_TABLES="DEMO_E,BMX_E,BPX_E,BPXO_J" Rscript Nhanes/R/00_download_cache.R   (subset, for validation)
# =====================================================================

suppressMessages({ library(nhanesA) })

REPO_ROOT <- Sys.getenv("REPO_ROOT", ".")
SRC <- file.path(REPO_ROOT, "Nhanes", "R", "examples.R")
