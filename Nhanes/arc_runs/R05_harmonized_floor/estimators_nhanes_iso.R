...
# The locked NHANES ladder (Nhanes/R/nhanes_arc.R -> codes/run_estimators) imports
...
# WITHOUT editing any canonical codes/*.R file:
#
...
# REUSES the exposed building blocks from codes/estimators.R:
...
# Sourced AFTER codes/estimators.R (which defines the building blocks + loads
...
run_estimators_iso <- function(obs, learners = "SL.glm", V_cf = 5L,
  ...
  ## certified estimator's UNWEIGHTED out-of-fold fits (valid under S _||_ (A,Y)|C).
