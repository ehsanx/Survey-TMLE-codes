...
#   canonical engine (codes/estimators.R via run_estimators) plus the already
#   IMPUTED analytic frames (Nhanes/analytic/<id>_imputed.rds). It edits NOTHING
#   in codes/ or Nhanes/R/.
#
...
#     (3) run_primary()     — run the CERTIFIED PRIMARY (3-learner near-Donsker
...
#              certified primary, Fully-Aware-CF).
